...
(function() {
	...
	getUnicodeFromIcon = function(icon) {
		...
		var matchValues = {
			...
			fa_wpforms: "298",
			fa_address_book: "2b9",
			fa_address_book_o: "2ba",
			fa_address_card: "2bb",
			fa_address_card_o: "2bc",
			fa_bandcamp: "2d5",
			fa_bath: "2cd",
			fa_bathtub: "2cd",
			fa_drivers_license: "2c2",
			fa_drivers_license_o: "2c3",
			fa_eercast: "2da",
			fa_envelope_open: "2b6",
			fa_envelope_open_o: "2b7",
			fa_etsy: "2d7",
			fa_free_code_camp: "2c5",
			fa_grav: "2d6",
			fa_handshake_o: "2b5",
			fa_id_badge: "2c1",
			fa_id_card: "2c2",
			...
			fa_telegram: "2c6",
			fa_thermometer: "2c7",
			fa_thermometer_0: "2cb",
			fa_thermometer_1: "2ca",
			fa_thermometer_2: "2c9",
			fa_thermometer_3: "2c8",
			fa_thermometer_4: "2c7",
			fa_thermometer_empty: "2cb",
			fa_thermometer_full: "2c7",
			fa_thermometer_half: "2c9",
			fa_thermometer_quarter: "2ca",
			fa_thermometer_three_quarters: "2c8",
			fa_times_rectangle: "2d3",
			fa_times_rectangle_o: "2d4",
			fa_user_circle: "2bd",
			fa_user_circle_o: "2be",
			fa_user_o: "2c0",
			fa_vcard: "2bb",
			fa_vcard_o: "2bc",
			fa_window_close: "2d3",
			fa_window_close_o: "2d4",
			fa_window_maximize: "2d0",
			fa_window_minimize: "2d1",
			fa_window_restore: "2d2",
			fa_wpexplorer: "2de"
		}
	...
	insertCDN = function() {
		...
		try {
			var CDN = '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css';
			var scimoz = ko.views.manager.currentView.scimoz;
			scimoz.replaceSel('');
